...
public class CenterRepository {
    ...
    private ConcurrentHashMap<String, ArrayList<Doctor>> mapOfDoctorsInCategory = new ConcurrentHashMap<String, ArrayList<Doctor>>();
    private List<Product> listOfProductsInShoppingList = Collections.synchronizedList(new ArrayList<Product>());
    private List<Doctor> listOfDoctorsInShoppingList = Collections.synchronizedList(new ArrayList<Doctor>());
    ...
    public List<Doctor> getListOfDoctorsInShoppingList() {
        return listOfDoctorsInShoppingList;
    }

    public void setListOfDoctorsInShoppingList(List<Doctor> listOfDoctorsInShoppingList) {
        this.listOfDoctorsInShoppingList = listOfDoctorsInShoppingList;
    }
    ...
    public ConcurrentHashMap<String, ArrayList<Doctor>> getMapOfDoctorsInCategory() {
        return mapOfDoctorsInCategory;
    }

    public void setMapOfDoctorsInCategory(ConcurrentHashMap<String, ArrayList<Doctor>> mapOfDoctorsInCategory) {
        this.mapOfDoctorsInCategory = mapOfDoctorsInCategory;
    }
}
